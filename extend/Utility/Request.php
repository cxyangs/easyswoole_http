...
// +----------------------------------------------------------------------
// | Request.php  Version 2018/11/11
// +----------------------------------------------------------------------
...
class Request
{
    ...
    public function __construct(\EasySwoole\Http\Response $response,\EasySwoole\Http\Request $request)
    {
        ...
        if (is_null($this->filter)) {
            $this->filter = Config::getInstance()->getConf('site.default_filter');
        }
        $this->method = $this->request->getMethod();
        $this->input =$this->param= $request->getRequestParam();
    }
